        ...
        while (1)
          switch ((_context2.prev = _context2.next)) {
            ...
            case 2:
              ...
              _context2.next = 5;
              return connection.query("SELECT * FROM tasks WHERE id = ?", [
                req.params.id,
              ]);
            case 5:
              _yield$connection$que3 = _context2.sent;
              _yield$connection$que4 = _slicedToArray(
        ...
        while (1)
          switch ((_context3.prev = _context3.next)) {
            ...
            case 5:
              ...
              _yield$connection$que6 = _slicedToArray(
                _yield$connection$que5,
                1
              );
        ...
        while (1)
          switch ((_context4.prev = _context4.next)) {
            ...
            case 5:
              ...
              _yield$connection$que8 = _slicedToArray(
        ...
        while (1)
          switch ((_context5.prev = _context5.next)) {
            ...
            case 2:
              ...
              _context5.next = 5;
              return connection.query("DELETE FROM tasks WHERE id = ?", [
                req.params.id,
              ]);
            case 5:
        ...
        while (1)
          switch ((_context6.prev = _context6.next)) {
            ...
            case 2:
              ...
              _context6.next = 5;
              return connection.query("UPDATE tasks SET ? WHERE id = ?", [
                req.body,
                req.params.id,
              ]);
            case 5:
